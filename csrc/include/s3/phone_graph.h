 ...
 * left contexts) is handled by the consumer (cvt2triphone /
 * state_seq_make), not by this layer; this module only describes the
 * combinatorial structure of the utterance.
 */
...
/* Diagnostic: print the graph in a readable form. Honors
 * NEXT_UTT_STATES_VERBOSE-style debugging needs. */
void
